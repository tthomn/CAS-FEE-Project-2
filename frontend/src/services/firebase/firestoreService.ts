...
export async function getDocDataBy1Condition<T>(
  ...
  try {
    ...
    console.error(
      `Error fetching documents from ${collectionName} where ${field} ${operator} ${value}:`,
      error,
    );
    throw error;
  }
...
export async function getDocRefsBy1Condition(
  ...
  try {
    ...
    console.error(
      `Error fetching documents from ${collectionName} where ${field1} ${operator1} ${value1}`,
      error,
    );
    throw error;
  }
...
export async function getDocRefsBy2Condition(
  ...
  try {
    ...
    console.error(
      `Error fetching documents from ${collectionName} where ${field1} ${operator1} ${value1} and ${field2} ${operator2} ${value2}:`,
      error,
    );
    throw error;
  }
...
export async function createDocRef(collectionName: string, documentId: string) {
  try {
    ...
    console.error(
      `Error creating document reference for ${collectionName}/${documentId}:`,
      error,
    );
    throw error;
  }
...
export async function createCollectionRef(collectionName: string) {
  try {
    ...
    console.error(
      `Error creating document reference for ${collectionName}`,
      error,
    );
    throw error;
  }
...
export async function setDocByRef(
  docRef: DocumentReference<DocumentData>,
  data: DocumentData,
): Promise<void> {
  try {
...
export async function updateDocByRef(
  docRef: DocumentReference<DocumentData>,
  fieldsToUpdate: Partial<DocumentData>,
): Promise<void> {
  try {
...
export async function deleteDocByRef(
  docRef: DocumentReference<DocumentData>,
): Promise<void> {
  try {
